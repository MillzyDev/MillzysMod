...
for ($i = 0; $i -lt 3; $i++) {
    $stats = & adb shell stat /sdcard/Android/data/com.stresslevelzero.bonelab/files/tombstone_0$i
...
& adb pull /sdcard/Android/data/com.stresslevelzero.bonelab/files/tombstone_0$recentTombstone $fileName
